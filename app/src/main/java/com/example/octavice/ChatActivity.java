...
import com.example.octavice.adapters.AdapterChat;
import com.example.octavice.models.ModelChat;
import com.example.octavice.models.ModelUser;
import com.example.octavice.notifications.APIService;
import com.example.octavice.notifications.Client;
import com.example.octavice.notifications.Data;
import com.example.octavice.notifications.Response;
import com.example.octavice.notifications.Sender;
import com.example.octavice.notifications.Token;
...
public class ChatActivity extends AppCompatActivity {
    ...
    //for checking if use has been message or not
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        * So get that uid here to get the profile picture, name and start chat with that user*/
        ...
        messageEt.addTextChangedListener(new TextWatcher() {
            ...
            @Override
            public void onTextChanged(CharSequence start, int i, int before, int count) {
